                    ...
                    <>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoans => (
                            <div key={shelfCurrentLoans.book.id}>
                                <div className="row mt-3 mb-3">
                                    <div className="col-4 col-md-4 container">
                                        {
                                            shelfCurrentLoans.book?.img ?
                                                <img src={shelfCurrentLoans.book?.img} width="222" height="349" alt="Book" />
                                                :
                                    ...
                                    <div className="card col-3 col-md-3 container d-flex">
                                        <div className="card-body">
                                            ...
                                            <Link className="btn btn-primary" to={`/checkout/${shelfCurrentLoans.book.id}`}>
                                                Leave a Review
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <hr />
                                <LoansModal shelfCurrentLoan={shelfCurrentLoans} mobile={false} returnBook={returnBook} renewLoan={renewLoan}/>
                            </div>
                        ))}
                    </> :
                    <>
                    ...
                    <>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoans => (
                            <div key={shelfCurrentLoans.book.id}>
                                    ...
                                    <div className="card d-flex mt-5 mb-3">
                                        <div className="card-body container">
                                            <div className="mt-3">
                                                ...
                                                <div className="list-group mt-3">
                                                    <button className="list-group-item list-group-item-action"
                                                        aria-current="true" data-bs-toggle="mobilemodal"
                                ...
                                <hr />
                                <LoansModal shelfCurrentLoan={shelfCurrentLoans} mobile={true} returnBook={returnBook} renewLoan={renewLoan}/>
                            </div>
                        ))}
                    </> :
                    <>
